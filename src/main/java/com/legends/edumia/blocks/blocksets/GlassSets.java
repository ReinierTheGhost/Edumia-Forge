...
public class GlassSets {
    ...
    public record GlassSet(RegistryObject<Block> block, RegistryObject<Block> pane){
    ...
    public static GlassSet registerGlassSet(String name, boolean stained, DyeColor color) {
        ...
        RegistryObject<Block> pane = null;
        if (stained) {
            ...
            block = registerBlock(name, () -> new GlassBlock(BlockBehaviour.Properties.of()
