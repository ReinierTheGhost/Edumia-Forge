...
public abstract class ConnectedTextureFaceMapper {
    ...
    public static ConnectedTexture2DContext get2dFrom3d(ConnectedTexture3DContext ctx3d, Direction side) {
        ...
        Set<ConnectedTexture2DContext.RelativePosition> relativePositions = EnumSet.noneOf(ConnectedTexture2DContext.RelativePosition.class);
        ConnectedTexture2DContext.RelativePosition[] var4 = RelativePosition.values();
