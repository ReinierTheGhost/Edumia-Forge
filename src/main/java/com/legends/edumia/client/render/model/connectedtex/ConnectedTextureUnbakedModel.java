...
public class ConnectedTextureUnbakedModel extends SimpleUnbakedGeometry<ConnectedTextureUnbakedModel> {
    ...
    @Override
    protected void addQuads(IGeometryBakingContext owner, IModelBuilder modelBuilder, ModelBaker baker, Function spriteGetter, ModelState modelTransform, ResourceLocation modelLocation) {
    ...
    @Override
    public BakedModel bake(IGeometryBakingContext owner, ModelBaker bakery, Function spriteGetter, ModelState modelState,
                           ItemOverrides overrides, ResourceLocation modelLocation) {
        TextureAtlasSprite particle = (TextureAtlasSprite) spriteGetter.apply(owner.getMaterial("particle"));
