...
public class EdumiaFoodComponent {
    ...
    public static final FoodProperties BANANA = new FoodProperties.Builder().nutrition(2).saturationMod(2f).build();
    public static final FoodProperties BANANA_BREAD = new FoodProperties.Builder().nutrition(5).saturationMod(6f).build();
    public static final FoodProperties MANGO = new FoodProperties.Builder().nutrition(4).saturationMod(2.4F).build();
    public static final FoodProperties DATE = new FoodProperties.Builder().nutrition(2).saturationMod(1.2f).build();
}
